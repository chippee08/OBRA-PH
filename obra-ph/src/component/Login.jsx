...
function Login() {
  return (
    <>
      <div className="flex bg-white items-center justify-center border-2 border-gray-300 rounded-lg shadow-lg w-[1000px] h-[400px]">
        {/* Login Form */}
        <div className='flex flex-col justify-center items-center p-8'>
          ...
          <form>
            ...
            <div className="mb-4">
              ...
              <a href="" className='text-[#595F3B]'><u>Forgot password?</u></a>
            </div>
            <div className="mb-4">
